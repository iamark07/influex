      ...
      <div className="container mx-auto px-4 sm:px-6 pt-16 pb-8 lg:pt-20">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-10">
          ...
          <div className="sm:col-span-2 md:col-span-4 xl:col-span-2 md:text-center xl:text-left">
            ...
            <p className="text-gray-400 text-sm max-w-2xl xl:max-w-sm md:mx-auto xl:mx-0 mt-4 leading-relaxed">
          ...
          <div className="sm:col-span-2 md:col-span-2 xl:col-span-2">
            ...
            <form className="mt-4 flex">
              <input
                ...
                className="w-full px-4 py-3 rounded-l-full bg-slate-800 border border-slate-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 text-xs lg:text-base"
              />
              <button
                type="submit"
                className="bg-pink-500 text-white px-4 py-3 rounded-r-full font-semibold hover:bg-pink-600 transition-colors shrink-0 text-xs lg:text-sm"
              >
                Subscribe
              </button>
            </form>
